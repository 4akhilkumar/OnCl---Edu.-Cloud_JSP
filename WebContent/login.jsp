            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12" style="border-radius: 5px;">
                        <form id="login-form" class="form" action="loginform" method="post">
                            <h3 class="text-center text-info"><i class="fa fa-sign-in" aria-hidden="true"></i> <b> Login </b> </h3>
                            <div class="form-group">
                                <label for="email" class="text-info"><i class="fa fa-envelope" aria-hidden="true"></i> E - Mail:</label><br>
                                <input type="email" name="email" id="email" class="form-control" placeholder="E - Mail" required>
                            </div>
                            <div class="form-group">
                                <label for="password" class="text-info"><i class="fa fa-key" aria-hidden="true"></i> Password:</label><br>
                                <input type="password" name="password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_()=+-]).{8,}$" title="Enter Your Strong Password" id="password" class="form-control" placeholder="Password" required>
                                <div style="padding: 10px; float:right; display:block;" class="forgot_password">
                                    <a href="forgot_password.jsp" style="color: #33b5e5 !important;"> Forgotten Password?&#128533; </a>
                                </div>
                            </div>
                            <div class="form-group">
                                <button type="submit" name="submit" class="btn btn-info"><i class="fa fa-sign-in" aria-hidden="true"></i> <b> Login </b> </button>
                            </div>
                        </form>
                    </div>
                </div>
