...
<html lang="en">
  ...
  <title>Course Sessions E - Cloud | OnCl - Edu. Cloud</title>
...
<%@include file="navbar_faculty.jsp" %>
  ...
  <div style="padding: 10px;">
    <a class="btn btn-bd-download" href="add_session_info_faculty.jsp" role="button"><i class="fas fa-video"></i> <b>Add Session</b></a>
    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
        <thead>
        <tr>
            <th class="th-sm"> <b> Session ID </b>
    
            </th>
            <th class="th-sm"> <b> Course Name </b>
    
            </th>
            <th class="th-sm"> <b> Topics </b>
    
            </th>
            <th class="th-sm"> <b> Shareable Link </b>
    
            </th>
            <th class="th-sm"> <b> Faculty Name </b>
    
            </th>
            <th class="th-sm"> <b> Faculty E - Mail </b>
    
            </th>
            <th class="th-sm"> <b> Faculty Phone No. </b>
        ...
        try{
            ...
            PreparedStatement stmt=con.prepareStatement("select * from sessions");
            ...
            while(rs.next()) {
            	...
            	<td>
            	<a href="<%=rs.getString(4) %>" target="_blank" style="color:#2196f3; text-decoration:none;" title="Click Here">
            	Shareable Link
            	</a>
            	</td>
            	...
            	<td><%=rs.getString(6) %></td>
 	            ...
 	            <td>
 	            <% if(rs.getString(6).equals(faculty_email)) {
            		%>
            		<a href="updateSession.jsp?sno=<%=rs.getInt(1)%>"><i class="far fa-edit"></i></a>
            		<%
            	}
            	%>
            	</td>
            	...
            	<% if(rs.getString(6).equals(faculty_email)) {
            		%>
            		<a href="deleteSession.jsp?sno=<%=rs.getInt(1)%>"><i class="fas fa-minus-circle"></i></a>
            		<%
            	}
            	%>
            	</td>
        ...
        <tr>
            ...
            <th> <b> Shareable Link </b>
            </th>
            <th> <b> Faculty Name </b>
            </th>
            <th> <b>  Faculty E - Mail </b>
            </th>
            <th> <b>  Faculty Phone No. </b>
            </th>
            <th> <b>  Edit </b>
            </th>
            <th> <b>  Delete </b>
