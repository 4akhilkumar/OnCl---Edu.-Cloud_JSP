...
<html lang="en">
  ...
  <title>Faculty Info. | OnCl - Edu. Cloud</title>
...
<%@include file="navbar_admin.jsp" %>
  ...
  <div style="padding: 10px;">
    <a class="btn btn-bd-download" href="add_faculty.jsp" role="button"><i class="fas fa-user-plus"></i> <b>Add Faculty</b></a>
    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <th class="th-sm"> <b> Teaching Field </b>
    
            </th>
            <th class="th-sm"> <b> Designation </b>
    
            </th>
            <th class="th-sm"> <b> Salary </b>
        ...
        try{
            ...
            while(rs.next()){
            	...
            	<td><a href="updateFaculty.jsp?email=<%=rs.getString(1)%>"><i class="far fa-edit"></i></a></td>
            <td><a href="deleteFaculty.jsp?email=<%=rs.getString(1)%>"><i class="fas fa-minus-circle"></i></a></td>
            	</tr>
            	<% 
            }
