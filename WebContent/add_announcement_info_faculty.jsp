            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12" style="border-radius: 5px;">
                        <form id="login-form" class="form" action="add_announcements_faculty.jsp" method="post">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-info" onclick="onSubmit()"><i class="fas fa-bullhorn"></i> <i class="far fa-newspaper"></i> <b>Make Announcement</b> </button>
                            </div>
                        </form>
                    </div>
                </div>
