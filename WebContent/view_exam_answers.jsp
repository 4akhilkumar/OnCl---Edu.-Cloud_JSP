            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-12">
                    <div id="login-box" class="col-md-12" style="border-radius: 5px;">
                        <form id="login-form" class="form" action="add_marks.jsp?email=<%=st_email %>" method="post">
                        <div style="visibility: hidden;">
                            <input type="text" name="coursename" value='<%=coursename %>' readonly>
                        </div>
                            <h3 class="text-center text-info"><i class="fas fa-book"></i> <b><%=coursename %>  Exam</b> </h3>
                            <div class="form-group">
                                <label for="text_field" class="text-info"><i class="fas fa-file-signature"></i> Question 1</label><br>
                                <textarea name="q1" id="text_field" class="form-control" placeholder="Write the Question..." readonly> <%=q1 %> </textarea>
                                <br>
                                <textarea name="a1" id="text_field" class="form-control" placeholder="Write the Answer..." readonly> <%=a1 %> </textarea>
                            </div>
                            <div class="form-group">
                                <label for="text_field" class="text-info"><i class="fas fa-file-signature"></i> Question 2</label><br>
                                <textarea name="q2" id="text_field" class="form-control" placeholder="Write the Question..." readonly> <%=q2 %> </textarea>
                                <br>
                                <textarea name="a2" id="text_field" class="form-control" placeholder="Write the Answer..." readonly> <%=a2 %> </textarea>
                            </div>
                            <div class="form-group">
                                <label for="text_field" class="text-info"><i class="fas fa-file-signature"></i> Question 3</label><br>
                                <textarea name="q3" id="text_field" class="form-control" placeholder="Write the Question..." readonly> <%=q3 %> </textarea>
                                <br>
                                <textarea name="a3" id="text_field" class="form-control" placeholder="Write the Answer..." readonly> <%=a3 %> </textarea>
                            </div>
                            <div class="form-group">
                                <label for="text_field" class="text-info"><i class="fas fa-file-signature"></i> Question 4</label><br>
                                <textarea name="q4" id="text_field" class="form-control" placeholder="Write the Question..." readonly> <%=q4 %> </textarea>
                                <br>
                                <textarea name="a4" id="text_field" class="form-control" placeholder="Write the Answer..." readonly> <%=a4 %> </textarea>
                            </div>
                            <div class="form-group">
                                <label for="text_field" class="text-info"><i class="fas fa-file-signature"></i> Question 5</label><br>
                                <textarea name="q5" id="text_field" class="form-control" placeholder="Write the Question..." readonly> <%=q5 %> </textarea>
                                <br>
                                <textarea name="a5" id="text_field" class="form-control" placeholder="Write the Answer..." readonly> <%=a5 %> </textarea>
                            </div>
                            <div class="form-group">
                                <label for="text_field" class="text-info"><i class="fas fa-file-signature"></i> Question 6</label><br>
                                <textarea name="q6" id="text_field" class="form-control" placeholder="Write the Question..." readonly> <%=q6 %> </textarea>
                                <br>
                                <textarea name="a6" id="text_field" class="form-control" placeholder="Write the Answer..." readonly> <%=a6 %> </textarea>
                            </div>
                            <div class="form-group">
                            	 <label for="text_field" class="text-info"><i class="fas fa-sort-numeric-up-alt"></i> Total Marks</label><br>
                            	 <input type="text" name="marks" id="marks" class="form-control" placeholder="Enter Marks" required>
                            </div>                            
                            <div class="form-group">
                                <button type="submit" class="btn btn-info"><i class="fas fa-check-double"></i> <b>Evaluation Done</b> </button>
                            </div>
                        </form>
                    </div>
                </div>
