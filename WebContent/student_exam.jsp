...
<%
String stemail=(String)session.getAttribute("student_email");
...
try {
	Connection con = null;
      ...
      PreparedStatement stmt=con.prepareStatement("select * from exam_faculty where coursename=?");
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-12">
                    <div id="login-box" class="col-md-12" style="border-radius: 5px;">
                        <form id="login-form" class="form" action="submit_exam.jsp?coursename=<%=coursename %>" method="post">
                        <div style="visibility: hidden;">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <textarea name="a1" id="text_field" class="form-control" placeholder="Write the Answer..."></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <br>
                                <textarea name="a2" id="text_field" class="form-control" placeholder="Write the Answer..."></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <br>
                                <textarea name="a3" id="text_field" class="form-control" placeholder="Write the Answer..."></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <br>
                                <textarea name="a4" id="text_field" class="form-control" placeholder="Write the Answer..."></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <br>
                                <textarea name="a5" id="text_field" class="form-control" placeholder="Write the Answer..."></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <br>
                                <textarea name="a6" id="text_field" class="form-control" placeholder="Write the Answer..."></textarea>
                            </div>
                            <div class="form-group">
