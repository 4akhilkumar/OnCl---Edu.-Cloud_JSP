...
try{
    ...
    PreparedStatement stmt=con.prepareStatement("select * from courses where email=?");
...
<html lang="en">
  <head>
    ...
    <title>Course Registration | OnCl - Edu. Cloud</title>
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12" style="border-radius: 5px;">
                        <form id="login-form" class="form" action="make_registration.jsp?id=<%=regid %>&name=<%=studentname %>" method="post">
                            <h3 class="text-center text-info"><i class="fas fa-book-open"></i> <b>Course Registration</b> </h3>
                            <div class="form-group">
                                <label for="email" class="text-info"><i class="fa fa-envelope" aria-hidden="true"></i> E - Mail:</label><br>
                                <input type="email" name="email" id="email" class="form-control" value="<%=email %>" placeholder="E - Mail" readonly>
                            </div>
                            <div class="row" style="justify-content: space-around; align-content: normal; align-items: normal; flex-wrap: wrap;">
	                            <div class="form-group">
	                                <label for="regid" class="text-info"><i class="fas fa-id-badge"></i> Registration ID</label><br>
	                                <input type="number" name="regid" id="regid" value="<%=regid %>" class="form-control" readonly>
	                            </div>
	                            <div class="form-group">
	                                <label for="studentname" class="text-info"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Student Name:</label><br>
	                                <input type="text" name="studentname" id="studentname" value="<%=studentname %>" class="form-control" readonly>
	                            </div>
                            </div>
                            <div class="row" style="justify-content: space-around; align-content: normal; align-items: normal; flex-wrap: wrap;">
	                            <div class="form-group">
	                                <label for="select" class="text-info"><i class="fa fa-steam" aria-hidden="true"></i> Course Name:</label><br>
	                                <select class="form-control" name="course1" style="width: 220px;" readonly>
	                                    <option value="Mathematical Programming">Mathematical Programming</option>
	                                </select>
	                            </div>
	                            <div class="form-group">
	                                <label for="select" class="text-info"><i class="fab fa-leanpub"></i> Mode of Study:</label><br>
	                                <select class="form-control" name="mos1" style="width: 220px;" required>
	                                    <option value="">Select Mode of Study</option>
	                                    <option value="Guided Regular">Guided Regular</option>
	                                    <option value="Guided Advance">Guided Advance</option>
	                                    <option value="Self Advance">Self Advance</option>
	                                    <option value="Self Regular">Self Regular</option>
	                                </select>
	                            </div>
                            </div>
                            <div class="row" style="justify-content: space-around; align-content: normal; align-items: normal; flex-wrap: wrap;">
	                            <div class="form-group">
	                                <label for="select" class="text-info"><i class="fa fa-steam" aria-hidden="true"></i> Course Name:</label><br>
	                                <select class="form-control" name="course2" style="width: 220px;" readonly>
	                                    <option value="Data Science">Data Science</option>
	                                </select>
	                            </div>
	                            <div class="form-group">
	                                <label for="select" class="text-info"><i class="fab fa-leanpub"></i> Mode of Study:</label><br>
	                                <select class="form-control" name="mos2" style="width: 220px;" required>
	                                    <option value="">Select Mode of Study</option>
	                                    <option value="Guided Regular">Guided Regular</option>
	                                    <option value="Guided Advance">Guided Advance</option>
	                                    <option value="Self Advance">Self Advance</option>
                            ...
                            <div class="row" style="justify-content: space-around; align-content: normal; align-items: normal; flex-wrap: wrap;">
	                            <div class="form-group">
	                                <label for="select" class="text-info"><i class="fa fa-steam" aria-hidden="true"></i> Course Name:</label><br>
	                                <select class="form-control" name="course3" style="width: 220px;" readonly>
	                                    <option value="Technical Skills">Technical Skills</option>	                                
	                                </select>
	                            </div>
	                            <div class="form-group">
	                                <label for="select" class="text-info"><i class="fab fa-leanpub"></i> Mode of Study:</label><br>
	                                <select class="form-control" name="mos3" style="width: 220px;" required>
	                                    <option value="">Select Mode of Study</option>
	                                    <option value="Guided Regular">Guided Regular</option>
	                                    <option value="Guided Advance">Guided Advance</option>
	                                    <option value="Self Advance">Self Advance</option>
                            ...
                            <div class="row" style="justify-content: space-around; align-content: normal; align-items: normal; flex-wrap: wrap;">
	                            <div class="form-group">
	                                <label for="select" class="text-info"><i class="fa fa-steam" aria-hidden="true"></i> Course Name:</label><br>
	                                <select class="form-control" name="course4" style="width: 220px;" readonly>
	                                    <option value="Enterprise Programming">Enterprise Programming</option>
	                                </select>
	                            </div>
	                            <div class="form-group">
	                                <label for="select" class="text-info"><i class="fab fa-leanpub"></i> Mode of Study:</label><br>
	                                <select class="form-control" name="mos4" style="width: 220px;" required>
	                                    <option value="">Select Mode of Study</option>
	                                    <option value="Guided Regular">Guided Regular</option>
	                                    <option value="Guided Advance">Guided Advance</option>
	                                    <option value="Self Advance">Self Advance</option>
                             ...
                             <div class="row" style="justify-content: space-around; align-content: normal; align-items: normal; flex-wrap: wrap;">
	                            <div class="form-group">
	                                <label for="select" class="text-info"><i class="fa fa-steam" aria-hidden="true"></i> Course Name:</label><br>
	                                <select class="form-control" name="course5" style="width: 220px;" readonly>
	                                    <option value="Computer Networks and Security">Computer Networks and Security</option>
	                                </select>
	                            </div>
	                            <div class="form-group">
	                                <label for="select" class="text-info"><i class="fab fa-leanpub"></i> Mode of Study:</label><br>
	                                <select class="form-control" name="mos5" style="width: 220px;" required>
	                                    <option value="">Select Mode of Study</option>
	                                    <option value="Guided Regular">Guided Regular</option>
	                                    <option value="Guided Advance">Guided Advance</option>
	                                    <option value="Self Advance">Self Advance</option>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-info"><i class="fas fa-book"></i> <b>Register Course</b> </button>
                            </div>
                        </form>
                    </div>
                </div>
