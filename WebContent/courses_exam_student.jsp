...
<html lang="en">
  ...
  <script>
      function ep_exam() {
        window.location.href = "check_exam.jsp?coursename=Enterprise Programming";
      }
      function ds_exam() {
        window.location.href = "check_exam.jsp?coursename=Data Science";
      }
      function cns_exam() {
        window.location.href = "check_exam.jsp?coursename=Computer Networks and Security";
      }
      function mp2_exam() {
        window.location.href = "check_exam.jsp?coursename=Mathematical Programming";
      }
      function ts_exam() {
        window.location.href = "check_exam.jsp?coursename=Technical Skills";
      }
  </script>
</html>