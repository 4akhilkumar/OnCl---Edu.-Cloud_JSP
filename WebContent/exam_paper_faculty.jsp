            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-12">
                    <div id="login-box" class="col-md-12" style="border-radius: 5px;">
                        <form id="login-form" class="form" action="add_question_paper.jsp" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="q1" minlength="11" id="text_field" class="form-control" placeholder="Write the Question..." required></textarea>
                                <br>
                            </div>
                            <div class="form-group">
                                <label for="text_field" class="text-info"><i class="fas fa-file-signature"></i> Question 2</label><br>
                                <textarea name="q2" minlength="11" id="text_field" class="form-control" placeholder="Write the Question..." required></textarea>
                                <br>
                            </div>
                            <div class="form-group">
                                <label for="text_field" class="text-info"><i class="fas fa-file-signature"></i> Question 3</label><br>
                                <textarea name="q3" minlength="11" id="text_field" class="form-control" placeholder="Write the Question..." required></textarea>
                                <br>
                            </div>
                            <div class="form-group">
                                <label for="text_field" class="text-info"><i class="fas fa-file-signature"></i> Question 4</label><br>
                                <textarea name="q4" minlength="11" id="text_field" class="form-control" placeholder="Write the Question..." required></textarea>
                                <br>
                            </div>
                            <div class="form-group">
                                <label for="text_field" class="text-info"><i class="fas fa-file-signature"></i> Question 5</label><br>
                                <textarea name="q5" minlength="11" id="text_field" class="form-control" placeholder="Write the Question..." required></textarea>
                                <br>
                            </div>
                            <div class="form-group">
                                <label for="text_field" class="text-info"><i class="fas fa-file-signature"></i> Question 6</label><br>
                                <textarea name="q6" minlength="11" id="text_field" class="form-control" placeholder="Write the Question..." required></textarea>
                                <br>
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-info"><i class="fas fa-save"></i> <b>Conduct Exam</b> </button>
                            </div>
                        </form>
                    </div>
                </div>
