            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12" style="border-radius: 5px;">
                        <form id="login-form" class="form" action="addFaculty.jsp" method="post">
                            <h3 class="text-center text-info"><i class="fas fa-user-plus"></i> <b>Add Faculty</b> </h3>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="field" title="Select Teaching Field" required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="designation" title="Select Designation" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" pattern="^[0-9]{1,6}$" title="Enter Salary" placeholder="Enter Salary" name="salary" id="salary" class="form-control" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-info"><i class="fas fa-user-plus"></i> <b>Add Faculty</b> </button>
                            </div>
                        </form>
                    </div>
                </div>
