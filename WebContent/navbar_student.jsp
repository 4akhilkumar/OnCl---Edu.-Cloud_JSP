...
<%
String regid="";
String student__firstname="";
String student__lastname="";
String studentname="";
...
try {
	Connection con = null;
      ...
      if(rs.next()){
    	  ...
    	  student__firstname=rs.getString(3);
    	  student__lastname=rs.getString(4);
    	  studentname=(new StringBuilder()).append(student__firstname).append(" "+student__lastname).toString();
      }
}
catch(Exception e){
	out.println(e);
        ...
        <div style="justify-content: flex-end;" class="row">
	        <div class="User-area">
			  <div class="User-avtar">
				  ...
				  <a title="<%=email %>"> <span class="_username"><%=email %></span></a>
			  </div>
