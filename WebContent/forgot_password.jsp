...
<html lang="en">
  <head>
    ...
    <title>Forgot Password | OnCl Account Recovery</title>
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12" style="border-radius: 5px;">
                        <form id="login-form" class="form" action="forgot.jsp" method="post">
                            <h3 class="text-center text-info"><i class="fas fa-lock"></i> <b> Forgot Password </b> </h3>
                            <div class="form-group">
                                <label for="email" class="text-info"><i class="fa fa-envelope" aria-hidden="true"></i> E - Mail:</label><br>
                                <input type="email" name="email" id="email" class="form-control" placeholder="Enter your assigned E - Mail" required>
                            </div>
                            <div class="form-group">
