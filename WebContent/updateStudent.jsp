            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12" style="border-radius: 5px;">
                        <form id="login-form" class="form" method="post" action="updateS.jsp?email=<%=email%>">
                            <h3 class="text-center text-info"> <i class="fas fa-user-edit"></i> <b>Update Student Info.</b> </h3>
                            <div class="form-group">
                                <label for="firstname" class="text-info"><i class="fa fa-user-circle-o" aria-hidden="true"></i> First Name:</label><br>
                                <input type="text" name="firstname" id="firstname" placeholder="First Name" class="form-control" value='<%=fname %>' required>
                            </div>
                            <div class="form-group">
                                <label for="lastname" class="text-info"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Last Name:</label><br>
                                <input type="text" name="lastname" id="lastname" placeholder="Last Name" class="form-control" value=<%=lname %> required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="phone" id="phone" class="form-control" placeholder="Phone Number" value=<%=phno %> required>
                            </div>
                            <div class="form-group">
                                <label for="select1" class="text-info"><i class="fa fa-steam" aria-hidden="true"></i> Study Branch:</label><br>
                                <select class="form-control" name="branch" required>
                                    <option value=<%=branch %> >Selected Branch is <%=branch %></option>
                                ...
                                <i id="select1" style="color: red;"></i>
                            </div>
                            <div class="form-group">
                                <label for="cgpa" class="text-info"><i class="fas fa-sort-numeric-up" aria-hidden="true"></i> Your Current Academic CGPA:</label><br>
                                <input type="text" name="cgpa" id="cgpa" class="form-control" value=<%=cgpa %> required>
                            </div>
                            <div class="form-group">
                                <label for="fee" class="text-info"><i class="fas fa-rupee-sign"></i> Fee:</label><br>
                                <input type="text" pattern="^[0-9]{1,6}$" title="Enter Fee" placeholder="Enter Fee" value=<%=fee %> name="fee" id="fee" class="form-control" required>
                            </div>                            
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-info"><i class="fas fa-user-edit"></i> <b>Update Student Info.</b> </button>
                            </div>
                        </form>
                    </div>
                </div>
