...
<html lang="en">
  <head>
    ...
    <title>Add Faculty | OnCl - Edu. Cloud</title>
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12" style="border-radius: 5px;">
                        <form id="login-form" class="form" action="update.jsp?email=<%=email %>" method="post">
                            <h3 class="text-center text-info"><i class="fas fa-user-edit"></i> <b>Update Faculty Info.</b> </h3>
                            <div class="form-group">
                                <label for="firstname" class="text-info"><i class="fa fa-user-circle-o" aria-hidden="true"></i> First Name:</label><br>
                                <input type="text" name="firstname" id="firstname" class="form-control" value='<%=fname %>' placeholder="First Name" required>
                            </div>
                            <div class="form-group">
                                <label for="lastname" class="text-info"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Last Name:</label><br>
                                <input type="text" name="lastname" id="lastname" class="form-control" value=<%=lname %> placeholder="Last Name" required>
                            </div>
                            <div class="form-group">
                                <label for="gender" class="text-info"><i class="fas fa-venus-mars"></i> Gender:</label><br>
                                <select class="form-control" name="gender" required>
                                    <option value="<%=gender %>" >Selected Gender is <%=gender %> </option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="phone" id="phone" class="form-control" value=<%=phno %> placeholder="Phone Number" required>
                            </div>
                            <div class="form-group">
                                <label for="select" class="text-info"><i class="fa fa-steam" aria-hidden="true"></i> Teaching Field:</label><br>
                                <select class="form-control" name="field" required>
                                    <option value="<%=field %>">Selected Teaching Field is <%=field %> </option>
                            ...
                            <div class="form-group">
                                <label for="select" class="text-info"><i class="fas fa-code-branch"></i> Designation:</label><br>
                                <select class="form-control" name="designation" required>
                                    <option value="<%=designation %>">Selected Designation is <%=designation %></option>
                            ...
                            <div class="form-group">
                                <label for="salary" class="text-info"><i class="fas fa-rupee-sign"></i> Salary:</label><br>
                                <input type="number" name="salary" id="salary" class="form-control" value=<%=salary %> placeholder="Salary" required>
                                <i id="salary" style="color: red;"></i>
                            </div>
                            <div class="form-group">
                                <label for="text_field" class="text-info"><i class="fas fa-comment-alt"></i> Write Current Address:</label><br>
                                <textarea name="address" id="text_field" class="form-control" placeholder="Current Address" required><%=address %></textarea>
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-info"> <i class="fas fa-user-edit"></i> <b>Update Faculty Info.</b> </button>
                            </div>
                        </form>
                    </div>
                </div>
