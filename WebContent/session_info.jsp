...
<%@include file="navbar_admin.jsp" %>
  ...
  <div style="padding: 10px;">
    <a class="btn btn-bd-download" href="add_session_info.jsp" role="button"><i class="fas fa-video"></i> <b>Add Session</b></a>
    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
        ...
        try{
            ...
            while(rs.next()) {
            	...
            	<td><a href="updateSession.jsp?sno=<%=rs.getInt(1)%>"><i class="far fa-edit"></i></a></td>
            	<td><a href="deleteSession.jsp?sno=<%=rs.getInt(1)%>"><i class="fas fa-minus-circle"></i></a></td>
            	</tr>
            	<% 
            }
        }
