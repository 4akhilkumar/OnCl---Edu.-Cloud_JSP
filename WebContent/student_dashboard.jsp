...
<html lang="en">
  <head>
    ...
    <title>Student Dashboard | OnCl - Edu. Cloud</title>
  ...
  <body>
    ...
    <div style="padding: 50px;">
      <div class="row" style="display: flex; justify-content: center; flex-wrap: wrap;">
        ...
        <div class="column">
            <div class="card" onclick="announcements_info_student()">
        ...
        <div class="column">
            <div class="card" onclick="exam_info()">
  ...
  <script>
      function course_info() {
        window.location.href = "course_info_student.jsp";
      }
      function exam_info() {
        window.location.href = "courses_exam_student.jsp";
      }
      function announcements_info_student() {
        window.location.href = "announcements_info_student.jsp";
      }
      function session_info() {
        window.location.href = "session_info_student.jsp";
      }
  </script>
</html>