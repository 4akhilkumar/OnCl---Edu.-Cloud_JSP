...
try {
	Connection con = null;
      ...
      stmt.setString(1, faculty_email);
      ResultSet rs=stmt.executeQuery();
      if(rs.next()) {
    	  faculty_firstname=rs.getString(3);
    	  faculty_lastname=rs.getString(4);
    	  faculty_phno=rs.getString(7);
    	  facultyname=(new StringBuilder()).append(faculty_firstname).append(" "+faculty_lastname).toString();
      }
}
catch(Exception e){
	out.println(e);
...
<html lang="en">
  <head>
    ...
    <title> Add Session(s) Info. | OnCl - Edu. Cloud</title>
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12" style="border-radius: 5px;">
                        <form id="login-form" class="form" action="add_session_faculty.jsp" method="post">
                            <h3 class="text-center text-info"><i class="fas fa-video"></i> <b>Add Session Info.</b> </h3>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="coursename" required>
                                    ...
                                    <option value="Cyber Security & Block Chain Technology">Cyber Security & Block Chain Technology</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="topics" class="text-info"><i class="fas fa-scroll"></i> Topics:</label><br>
                                <textarea name="topics" minlength="8" id="topics" class="form-control" placeholder="Write the Topics" required></textarea>
                            </div>
                            <div class="form-group">
                                <label for="shareablelink" class="text-info"><i class="fas fa-link"></i> Shareable Link:</label><br>
                                <textarea name="shareablelink" minlength="20" id="shareablelink" class="form-control" placeholder="Enter Session Shareable Link" required></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-info"> <i class="fas fa-video"></i> <b>Add Session Info.</b> </button>
                            </div>
                        </form>
                    </div>
                </div>
