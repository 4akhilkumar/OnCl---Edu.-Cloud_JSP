...
<%@include file="navbar_student.jsp" %>
  <div style="padding: 10px;">
    <a class="btn btn-bd-download" href="course_info_register.jsp" role="button"><i class="fas fa-book"></i> <b>Course Registration</b></a>
    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
        <thead>
        <tr>
            <th class="th-sm"> <b> Student ID </b>
    
            </th>
            <th class="th-sm"> <b> Student Name </b>
    
            </th>
            <th class="th-sm"> <b> Mathematical Programming - 2 </b>
    
            </th>
            <th class="th-sm"> <b> Data Science </b>
    
            </th>
            <th class="th-sm"> <b> Computer Networks & Security </b>
        ...
        <tr>
            ...
            <th> <b> Mathematical Programming - 2 </b>
            </th>
            <th> <b> Data Science </b>
            </th>
            <th> <b> Computer Networks & Security </b>
            </th>
