...
<main role="main" class="container">
  <div class="starter-template">
    <h1>Already, Registration Completed!</h1>
    <p class="lead">You have successfully completed your registration regarding courses.<br> You can check in your registered course details in <a href="course_info_student.jsp"><span style="font-weight: bold;">Courses Info. </span> </a>.</p>
  </div>
</main>
