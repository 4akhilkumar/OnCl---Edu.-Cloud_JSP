...
<html lang="en">
  ...
  <title>News & Announcements | OnCl - Edu. Cloud</title>
...
<body>
  ...
  <div style="padding: 10px;">
    <a class="btn btn-bd-download" href="add_announcement_info_faculty.jsp" role="button"><i class="far fa-newspaper"></i> <b>Add Announcement</b></a>
    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
        <thead>
        <tr>
            <th class="th-sm"> <b> S.No. </b>
    
            </th>
            <th class="th-sm"> <b> Subject </b>
    
            </th>
            <th class="th-sm"> <b> Announcement </b>
        ...
        try{
            ...
            PreparedStatement stmt=con.prepareStatement("select * from announcement");
            ...
            while(rs.next()){
            	...
            	<td>
            	<% if(rs.getString(5).equals(faculty_email)) {
            		%>
            		<a href="updateAnnouncement.jsp?sno=<%=rs.getInt(1)%>"><i class="far fa-edit"></i></a>
            		<%
            	}
            	%>
            	</td>
            	...
            	<% if(rs.getString(5).equals(faculty_email)) {
            		%>
            		<a href="deleteAnnouncement.jsp?sno=<%=rs.getInt(1)%>"><i class="fas fa-minus-circle"></i></a>
            		<%
            	}
            	%>
            	</td>
